    ...
    <img src="/uploads/{{ Auth::user()->slika }}" style="width:32px; height:32px; position:absolute; top:10px; left:10px; border-radius:50%">
    {{ Auth::user()->name }} <span class="caret"></span>
							...
							<li><a href="{{ route('tags.index') }}"><i class="fa fa-tags"></i>&nbsp Tagovi</a></li>
							@endif
                                    ...
                                    <li>
                                        <a href="{{ route('logout') }}"
                                           ...
                                           <i class="fa fa-btn fa-sign-out"></i> Izloguj se
                                        </a>
